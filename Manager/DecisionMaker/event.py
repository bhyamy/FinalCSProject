...
class Event(object):
    ...
    def __parse_instruction(instruction):
        ...
        max_range = int(instruction[1]) if instruction[1] != '-' else c.EEG_MAX_FREQ
    ...
    def should_be_activated(self, processed_data):
        ...
        """
        for i in range(self.__range[0] * c.EEG_SAMPLING_RATE, self.__range[1] * c.EEG_SAMPLING_RATE + 1):
